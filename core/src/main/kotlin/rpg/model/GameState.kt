...
data class PlayerState(
    ...
    val cashFirstPurchaseBonusConsumed: Boolean = false,
    val lastCashPurchaseEpochMs: Long = 0L,
    val lastActiveEpochMs: Long = 0L,
    val autoContinueDungeon: Boolean = false,
    val autoPotionEnabled: Boolean = false,
    val autoPotionThresholdPct: Int = 35,
    val autoCraftEnabled: Boolean = false,
    val premiumExpiresAtEpochMs: Long = 0L,
    val premiumPermanent: Boolean = false,
